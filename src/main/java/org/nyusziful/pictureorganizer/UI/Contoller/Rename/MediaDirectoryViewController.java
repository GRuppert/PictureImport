...
public class MediaDirectoryViewController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        directoryList.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<MediaDirectoryInstance>() {
                    public void changed(ObservableValue<? extends MediaDirectoryInstance> observable,
                                        MediaDirectoryInstance oldValue, MediaDirectoryInstance newValue) {
                        if (newValue == null) {
                            resetFields();
                        } else {
    ...
    private void handleApplyEventNameButtonAction() {
        ...
        final MediaDirectoryInstance selectedItem = directoryList.getSelectionModel().getSelectedItem();
