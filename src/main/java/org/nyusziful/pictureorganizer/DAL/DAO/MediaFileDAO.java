...
public interface MediaFileDAO extends CRUDDAO<MediaFile> {
    ...
    MediaFile getMediafileByImage(String hash, String type, Integer shotnumber);
    MediaFile getMediafileByImage(String hash, String type, Integer shotnumber, boolean batch);
